...
class ElementBasedComparatorTest {
	...
	void checkElementComparatorSystem() {
		...
		String[] expected = {"d", "pictures", "x"};
		assertArrayEquals(expected,elementToStringArray(root.findDirByName("home").getChildren((ApfsElement o1, ApfsElement o2) -> o1.getOwnerName().compareTo(o2.getOwnerName()))));
	}
	...
	void checkElementComparatorPictures() {
		...
		assertArrayEquals(expected,elementToStringArray(root.findDirByName("pictures").getChildren((ApfsElement o1, ApfsElement o2) -> o1.getOwnerName().compareTo(o2.getOwnerName()))));
	}
}
